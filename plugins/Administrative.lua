...
if (mr_roo[1]:lower() == "panelsudo" or mr_roo[1] == "پنل سودو") and is_admin(msg) and is_JoinChannel(msg) then
	...
	tdbot.getInlineQueryResults(BotTiiGeR_idapi, msg.to.id, 0, 0, "Sudo:"..msg.to.id, 0, inline_query_cb, nil)
end
--######################################################################--
...
if (mr_roo[1]:lower() == 'panelgp' or mr_roo[1] == 'پنل گروه') and is_admin(msg) and is_JoinChannel(msg) then
	...
	tdbot.getInlineQueryResults(BotTiiGeR_idapi, msg.to.id, 0, 0, "Menu:"..mr_roo[2], 0, inline_query_cb, nil)
end
--######################################################################--
...
run = TiiGeRTeaM, pre_process = pre_processTools
}
