--Begin Msg-Checks.lua By @Arashwm
...
local function pre_process(msg)
	...
	if not redis:get(RedisIndex.."TiiGeRLikes") then redis:set(RedisIndex.."TiiGeRLikes",0) end
	if not redis:get(RedisIndex.."TiiGeRDisLikes") then redis:set(RedisIndex.."TiiGeRDisLikes",0) end
