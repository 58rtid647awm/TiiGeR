...
function group_settings(msg, target)
	...
	local gif = (mute_gif == "Warn") and "اخطار" or ((mute_gif == "Kick") and "اخراج" or ((mute_gif == "Mute") and "سکوت" or ((mute_gif == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local photo = (mute_photo == "Warn") and "اخطار" or ((mute_photo == "Kick") and "اخراج" or ((mute_photo == "Mute") and "سکوت" or ((mute_photo == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local sticker = (mute_sticker == "Warn") and "اخطار" or ((mute_sticker == "Kick") and "اخراج" or ((mute_sticker == "Mute") and "سکوت" or ((mute_sticker == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local contact = (mute_contact == "Warn") and "اخطار" or ((mute_contact == "Kick") and "اخراج" or ((mute_contact == "Mute") and "سکوت" or ((mute_contact == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local inline = (mute_inline == "Warn") and "اخطار" or ((mute_inline == "Kick") and "اخراج" or ((mute_inline == "Mute") and "سکوت" or ((mute_inline == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local game = (mute_game == "Warn") and "اخطار" or ((mute_game == "Kick") and "اخراج" or ((mute_game == "Mute") and "سکوت" or ((mute_game == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local text = (mute_text == "Warn") and "اخطار" or ((mute_text == "Kick") and "اخراج" or ((mute_text == "Mute") and "سکوت" or ((mute_text == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local keyboard = (mute_keyboard == "Warn") and "اخطار" or ((mute_keyboard == "Kick") and "اخراج" or ((mute_keyboard == "Mute") and "سکوت" or ((mute_keyboard == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local forward = (mute_forward == "Warn") and "اخطار" or ((mute_forward == "Kick") and "اخراج" or ((mute_forward == "Mute") and "سکوت" or ((mute_forward == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local views = (lock_views == "Warn") and "اخطار" or ((lock_views == "Kick") and "اخراج" or ((lock_views == "Mute") and "سکوت" or ((lock_views == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local location = (mute_location == "Warn") and "اخطار" or ((mute_location == "Kick") and "اخراج" or ((mute_location == "Mute") and "سکوت" or ((mute_location == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local document = (mute_document == "Warn") and "اخطار" or ((mute_document == "Kick") and "اخراج" or ((mute_document == "Mute") and "سکوت" or ((mute_document == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local voice = (mute_voice == "Warn") and "اخطار" or ((mute_voice == "Kick") and "اخراج" or ((mute_voice == "Mute") and "سکوت" or ((mute_voice == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local audio = (mute_audio == "Warn") and "اخطار" or ((mute_audio == "Kick") and "اخراج" or ((mute_audio == "Mute") and "سکوت" or ((mute_audio == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local video = (mute_video == "Warn") and "اخطار" or ((mute_video == "Kick") and "اخراج" or ((mute_video == "Mute") and "سکوت" or ((mute_video == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local video_note = (mute_video_note == "Warn") and "اخطار" or ((mute_video_note == "Kick") and "اخراج" or ((mute_video_note == "Mute") and "سکوت" or ((mute_video_note == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local link = (lock_link == "Warn") and "اخطار" or ((lock_link == "Kick") and "اخراج" or ((lock_link == "Mute") and "سکوت" or ((lock_link == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local tag = (lock_tag == "Warn") and "اخطار" or ((lock_tag == "Kick") and "اخراج" or ((lock_tag == "Mute") and "سکوت" or ((lock_tag == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local username = (lock_username == "Warn") and "اخطار" or ((lock_username == "Kick") and "اخراج" or ((lock_username == "Mute") and "سکوت" or ((lock_username == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local arabic = (lock_arabic == "Warn") and "اخطار" or ((lock_arabic == "Kick") and "اخراج" or ((lock_arabic == "Mute") and "سکوت" or ((lock_arabic == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local mention = (lock_mention == "Warn") and "اخطار" or ((lock_mention == "Kick") and "اخراج" or ((lock_mention == "Mute") and "سکوت" or ((lock_mention == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local edit = (lock_edit == "Warn") and "اخطار" or ((lock_edit == "Kick") and "اخراج" or ((lock_edit == "Mute") and "سکوت" or ((lock_edit == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local markdown = (lock_markdown == "Warn") and "اخطار" or ((lock_markdown == "Kick") and "اخراج" or ((lock_markdown == "Mute") and "سکوت" or ((lock_markdown == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local webpage = (lock_webpage == "Warn") and "اخطار" or ((lock_webpage == "Kick") and "اخراج" or ((lock_webpage == "Mute") and "سکوت" or ((lock_webpage == "Enable") and "TiiGeRLock" or "TiiGeRUnlock")))
	local bots =  (lock_bots == "Enable" and "TiiGeRLock" or "TiiGeRUnlock")
	local all =  (mute_all == "Enable" and "TiiGeRLock" or "TiiGeRUnlock")
	local tgservice =  (mute_tgservice == "Enable" and "TiiGeRLock" or "TiiGeRUnlock")
	local join =  (lock_join == "Enable" and "TiiGeRLock" or "TiiGeRUnlock")
	local pin =  (lock_pin == "Enable" and "TiiGeRLock" or "TiiGeRUnlock")
	local spam =  (lock_spam == "Enable" and "TiiGeRLock" or "TiiGeRUnlock")
	local flood =  (lock_flood == "Enable" and "TiiGeRLock" or "TiiGeRUnlock")
	local welcome = (lock_welcome == "Enable" and "TiiGeRLock" or "TiiGeRUnlock")
	local expire_date = ''
	local expi = redis:ttl(RedisIndex..'ExpireDate:'..msg.to.id)
	if expi == -1 then
		expire_date = 'نامحدود!'
	...
	text = string.gsub(text, 'TiiGeRUnlock', M_START.."غیرفعال")
	text = string.gsub(text, 'TiiGeRLock', M_START.."فعال")
...
function info_by_username(arg, data)
	...
	if tonumber(data.id) then
		function info_cb(arg, data)
			...
			local hash = 'rank:'..arg.chat_id..':variables'
			local text = ""..M_START.."*نام :* `"..firstname.."`\n"..M_START.."*فامیلی :* `"..lastname.."`\n"..M_START.."*نام کاربری :* "..username.."\n"..M_START.."*آیدی :* `"..data.id.."`\n"
			if data.id == tonumber(Aarashwm) then
				text = text..M_START..'*مقام :* `سازنده سورس`\n'
			elseif is_sudo1(data.id) then
				text = text..M_START..'*مقام :* `سودو ربات`\n'
			elseif is_admin1(data.id) then
