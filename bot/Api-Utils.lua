...
function options(msg, GP_id)
	...
	keyboard.inline_keyboard = {
		{
            {text = "❤️ "..tostring(redis:get(RedisIndex.."TiiGeRLikes")), callback_data="/like:"..GP_id},
            {text = "💔 "..tostring(redis:get(RedisIndex.."TiiGeRDisLikes")), callback_data="/dislike:"..GP_id}
        },
		{
...
function helplist(msg, GP_id)
	...
	keyboard.inline_keyboard = {
		{
            {text = "❤️ "..tostring(redis:get(RedisIndex.."TiiGeRLikes")), callback_data="/likehelp:"..GP_id},
            {text = "💔 "..tostring(redis:get(RedisIndex.."TiiGeRDisLikes")), callback_data="/dislikehelp:"..GP_id}
        },
		{
...
function addlimpanel(msg, GP_id)
	...
	keyboard.inline_keyboard = {
		{
			{text = '❃ محدودیت اضافه کردن : '..getadd..'', callback_data = 'TiiGeRTeaM:'..GP_id}
		},
		{
		...
		{
			{text = '❃ وضعیت محدودیت : '..sadd..'', callback_data = 'TiiGeRTeaM:'..GP_id}
		},
		{
		...
		{
			{text = '❃ ارسال پیام محدودیت : '..addpm..'', callback_data = 'TiiGeRTeaM:'..GP_id}
		},
		{
