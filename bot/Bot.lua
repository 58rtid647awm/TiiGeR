...
function create_config( )
	...
	sudo_users = {654606653,SUDO,BotTiiGeR_id,BotTiiGeR_idapi},
	admins = {},
	disabled_channels = {},
...
function is_JoinChannel(msg)
	...
	if (not Joinchanel.ok or Joinchanel.result.status == "left" or Joinchanel.result.status == "kicked") and not is_sudo(msg) then
		...
		tdbot.getInlineQueryResults(BotTiiGeR_idapi, msg.chat_id, 0, 0, "Join", 0, inline_query_cb, nil)
	else
		return true
	end
end
